...
public class qus_Of_2_D_Array {
    ...
    public static void numberOfpresenc(int arr[][], int key) {
        int count = 0;
        for (int i = 0; i < arr.length; i++) {
            for (int j = 0; j < arr[0].length; j++) {
        ...
        System.out.println(key + "'s Present is " + count + " times");
    }
    ...
    public static int sumOf2ndRow(int nums[][]) {
        ...
        for (int j = 0; j < nums[0].length; j++) {
            ...
            sum += nums[1][j]; //yaha pe row jo hai o fix hai kyuki ki second row means 1.
    ...
    public static void main(String[] args) {
        ...
        // Q6)Print the number of 7's that are in the 2DArray.
        // System.out.println("Enter the length of ROw: ");
        // int row = sc.nextInt();
        // System.out.println("ENter the length of COlumn: ");
        // int col = sc.nextInt();
        ...
        // System.out.println("ENter the vlaue in Array: ");
        // for (int i = 0; i < row; i++) {
        // for (int j = 0; j < col; j++) {
        // arr[i][j] = sc.nextInt();
        // }
