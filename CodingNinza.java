...
public class CodingNinza {
    ...
    public static void main(String[] args) {
        ...
        // Q1)Given an integer ‘N’, you are supposed to return the square of the given
        // integer without using multiplication (*), division (/) or power function
        // (pow()).
        ...
        // Q2)You are given a positive integer ‘N’. You have to check whether ‘N’ can be
        // represented as a sum of two even numbers or not.
        ...
        // }
        // else{
        // System.out.println("The "+val+" does not represent as a sum of Two even
        // numbers");
        // }
        ...
        // Q3)You are given a string 'str' of length 'N'.Your task is to reverse the
        // original string word by word.
        ...
        // Q)You are given a string 'STR'. The string contains [a-z] [A-Z] [0-9]
        // [special characters]. You have to find the reverse of the string.For
        // example:If the given string is: STR = "abcde". You have to print the string
        // "edcba".
        ...
        // Q)You are given a 32-bit integer ‘N’. Your task is to toggle the rightmost
        // ‘K’ bits in the given integer and return the new integer.For Example :If ‘N’
        // = 12 and ‘K’ = 2:The binary representation of 12 is ‘1100’, after toggling
        // rightmost 2 bits, it becomes ‘1111’ i.e. 15. Hence, the answer is 15.
        ...
        // Q)You are given an array/list 'ARR' consisting of 'N' non - negative
        // integers. Your task is to return the running absolute difference of the
        // elements at even and odd index positions separately.The index of the first
        // element in the array is considered to be zero that is 0 - based indexing is
        // considered for calculating the parity of the index.
